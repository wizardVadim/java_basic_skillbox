...
public class Main {
    ...
    private static final Marker ERRORUSER = MarkerManager.getMarker("ERRORUSER");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.fatal(EXCEPTION, "Произошло исключение: " + ex);
        }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                logger.info(IMPORTANT, "Искомая станция: " + line);
                return station;
            }
            logger.error(ERRORUSER, "Станция не найдена: " + line);
