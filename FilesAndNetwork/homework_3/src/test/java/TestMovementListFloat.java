...
public class TestMovementListFloat {
    ...
    void testSumIncome() {
        assertEquals(1500.5, new Movements("target/test-classes/movementListFloat.csv").getIncomeSum(), DELTA);
    }

    @Test
    @DisplayName("Сумма расходов")
    void testSumExpense() {
        assertEquals(300.03, new Movements("target/test-classes/movementListFloat.csv").getExpenseSum(), DELTA);
    }
