...
public class TestMovementList {
    ...
    void testSumIncome() {
        assertEquals(460_800.0, new Movements("target/test-classes/movementList.csv").getIncomeSum(), DELTA);
    }

    @Test
    @DisplayName("Сумма расходов")
    void testSumExpense() {
        assertEquals(466_393.07, new Movements("target/test-classes/movementList.csv").getExpenseSum(), DELTA);
    }
